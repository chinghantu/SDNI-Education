...
import banner1 from '../../assets/Image/banner_SudsAndScience.png';
    ...
    render() {
        ...
        return (
            <div id="home-wrapper">
                ...
                {/*            <div className="btn banner-item">*/}
                {/*                <img className="d-block w-100" src={banner1} alt="" />*/}
                {/*                /!*<button id="register_btn">*!/*/}
                {/*                    <a id="register_btn" href="https://www.fleetscience.org/events/suds-science" target="_blank">*/}
                {/*                        <pre id="register_link">More info/Register</pre>*/}
                {/*                    </a>*/}
                {/*                /!*</button>*!/*/}
