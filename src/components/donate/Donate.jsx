                ...
                <div className="container1">
                    <div className="row">
                        ...
                        <div className="col-sm-7 main-content">
                            ...
                            <p>
                                Please help us reach our $150,000 funding goal for year 2020.<br/><br/>
                                ...
                                2. In the middle of the page, a new window will appear: under "Please Select a Fund", click on the scroll down arrow and select  "Nano3 and SDNI (San Diego Nanotechnology Infrastructure)" (It is the only option so far).<br/>
